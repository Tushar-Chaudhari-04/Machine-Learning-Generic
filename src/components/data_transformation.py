...
class DataTransformation:
   ...
   def initiate_data_transformation(self,train_path,test_path):
      try:
         ...
         logging.info(f"Applying preprocessing obj on train and test data")
         ...
         logging.info(f"Saving preprocessing obj ...")
         ...
         logging.info("Exception in initiate_data_transformation",e)
         raise CustomException(e,sys)
